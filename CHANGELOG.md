...
- **Temporal keyword now matches the deposit.** The hard-coded `1993–2025`
...
- **Optional visualization step** in `PhenoPhaseR.R` (runs after the
  ...
  - `plot_phenology_window_timeseries.R` — renders an AOI-aggregated
    phase-window time-series across the full 1993–2025 axis for
...
- **`.aggregate_per_phase()`** helper in `build_phase_cog_ro_crate.R`
  ...
  multi-band COGs (one band per year, 1993–2025, band names equal to
