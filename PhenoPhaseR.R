...
# elements. Hook B additionally embeds Data-Fitness-for-Purpose (DFFP)
# reviews if dffp_dir is supplied. Mirrors the in-pipeline publishing
# pattern of WeatherIndicatoR (Möller 2026, doi:10.5281/zenodo.19631197).
#
...
#   - vam/                              Step 7 validation accuracy metrics
...
map_res <- plot_phenology_raster_maps(
  doy_file = "~/PhenoPhaseR/output/ro_crate_phase/cogs/DOY_202-15_2018.tif",
  bse_file = "~/PhenoPhaseR/output/ro_crate_phase/cogs/BSE_202-15_2018.tif",
