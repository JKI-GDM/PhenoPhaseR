...
map_res <- plot_phenology_raster_maps(
  doy_file = paste0(output_dir,"/ro_crate_phase/_per_year/cogs/DOY_203-15_2018.tif"),
  bse_file = paste0(output_dir,"/ro_crate_phase/_per_year/cogs/BSE_203-15_2018.tif"),
  plant = 203, target_phase = 15, year = 2018,
...
ts_res <- plot_phenology_window_timeseries(
  ...
  aoi         = "Uckermark",
  plant       = 203, crop_label = "Winter wheat",
...
message(
  ...
  "\n",
  "Both ZIPs are ready for upload to Zenodo as new versions of the\n",
  "concept records for this crop. For winter wheat (plant 202) these are:\n",
