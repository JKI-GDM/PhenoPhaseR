...
-   **Auto-written Hook B README** extended with both local and `/vsicurl/`-streaming COG access examples (R and CLI).
-   **No numerical changes** from v1.6.0. The change is in `crop_spec`-vs-`crop` parameter name, Hook B's outer file layout, and documentation.
...
> Möller, M. & Gerstmann, H. (2026). *PhenoPhaseR: Reproducible processing workflow for interpolating phenological DWD observations* (v1.6.1). Zenodo. <https://doi.org/10.5281/zenodo.18743008>
