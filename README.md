...
| **SKOS** (W3C) | `http://www.w3.org/2004/02/skos/core#` | Bridge from DQV metrics to ISO 19157-1 quality dimensions (`skos:closeMatch`) |
...
| **GeoNames** | `https://www.geonames.org/` | Place identifier on `spatialCoverage` (the only domain-specific URI carried by the crate after v1.6.3's AGROVOC removal) |
...
> Möller, M. & Gerstmann, H. (2026). *PhenoPhaseR: Reproducible processing workflow for interpolating phenological DWD observations* (v1.6.3). Zenodo. <https://doi.org/10.5281/zenodo.18743008>
