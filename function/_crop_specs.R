...
#     for the seven crops in scope of the family blueprint
...
# the FAO Linked Open Data cloud. (A Wikidata cross-link field was removed:
# AGROVOC does not publish skos:exactMatch links to Wikidata for these concepts,
# and the hand-added QIDs were unverifiable and, on checking, all incorrect. Use
# the AGROVOC-published matches (NAL, World Bank, DBpedia) if a second identifier
# is ever needed.)
#
# IMPORTANT: AGROVOC URIs below are best-effort. Verify each against the
# AGROVOC SPARQL endpoint before publishing a new deposit.
.CROP_SPECS <- list(
  "202" = list(
    dwd_id          = 202L,
