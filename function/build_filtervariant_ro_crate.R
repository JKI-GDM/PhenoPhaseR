...
.quality_element <- function(measure, value, unit_text = NULL,
  ...
  el <- list(
    ...
    # HONEST ANCHORING (v1.7.0): bare measure token, not a fabricated
    # iso19157:<measure> IRI. No cv_rmse / etc. concept exists in ISO 19157;
    # the standard link is made only at the dimension-class level via the
    # metric entity's dqv:inDimension. See build_phase_cog_ro_crate.R.
...
.metric_entity <- function(measure) {
  # HONEST ANCHORING (v1.7.0): no fabricated skos:closeMatch to
  # iso19157:<measure>. Only the genuine ISO dimension CLASS is referenced,
  # via dqv:inDimension. See build_phase_cog_ro_crate.R for the rationale.
  list(
